...
import (
	...
	"ikpi-member-go/app/middleware"
	"ikpi-member-go/app/models"
	configuration "ikpi-member-go/config"
	"ikpi-member-go/database"
	"ikpi-member-go/routes"
...
func main() {
	...
	// Initialize database
	db, err := database.New(&database.ConfigDatabase{
